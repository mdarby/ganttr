...
Drop Raphael, jQuery and ganttr.js into your webroot.
...
Once configured the way you like, you should "minify":http://dean.edwards.name/packer/ ganttr.js and add the result to your webroot.
