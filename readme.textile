...
You're looking at it. Just clone this repo, run "ruby sever.rb", then point your browser to http://localhost:4567
You'll need to install the Sinatra gem if you haven't already.
